...
export default function Privacy(initialData) {
  ...
  const [currentItem, setCurrentItem] = useState('terms-and-conditions')
                ...
                <div className="flex flex-wrap relative">
                  <div className="w-full lg:w-[45%]">
                    <div className="lg:sticky lg:top-[90px] lg:min-h-[calc(100dvh-100px)] lg:flex lg:flex-wrap">
                      ...
                      <h1 className="text-[25vw] md:text-[19w] lg:text-[16vw] mb-4 leading-[0.6] md:leading-[0.6] lg:leading-[0.6] hidden lg:block w-full mt-auto">{privacy.title}</h1>
                    </div>
                  </div>
