  ...
  return(
    <div className="flex flex-wrap lg:justify-center relative overflow-visible">
      ...
      <div className="relative w-full flex flex-wrap lg:justify-center">
        {items.map((e, i) => {
          return (
            <div className={`transition-all ease-[cubic-bezier([0.83,0,0.17,1])] duration-[900ms] flex flex-wrap lg:block lg:pb-12 ${i == currentItem ? 'opacity-100 blur-0 delay-[300ms]' : 'opacity-0 blur-[70px]' } w-full ${i == 0 ? 'relative' : 'absolute top-0 left-0' }`} key={i}>
